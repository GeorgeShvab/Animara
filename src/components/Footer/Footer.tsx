...
const Footer: FC = () => {
  return (
    <footer className="py-10 md:py-8 bg-black-light">
      <div className="mb-6">
        <div className="px-8 md:px-16 flex flex-col md:flex-row justify-between gap-6 md:gap-20 items-center relative container">
          <div className="flex gap-20">
            <span className=" font-marko text-2xl md:text-3xl rounded-lg text-white">
              An<span className="text-theme">i</span>mara
            </span>
          </div>
          <div className="flex gap-4 md:gap-7 md:absolute md:left-1/2 md:translate-x-[-50%] flex flex-wrap justify-center md:justify-start">
            <Link
              href="/"
              className="text-neutral-400 hover:text-neutral-100 transition-color duration-300 text-sm whitespace-nowrap"
            >
              Home
            </Link>
            <Link
          ...
          <ul className="text-neutral-500 flex gap-2.5 justify-center items-center md:justify-end">
            <li>
              <a
                className="transition-colors text-neutral-200 hover:text-neutral-50"
              ...
              >
                <svg width="24" height="24" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    ...
                    fill="currentColor"
                  ></path>
                  <path d="M21.6 28.8V20.8L28 24.8001L21.6 28.8Z" fill="currentColor"></path>
                </svg>
              </a>
            </li>
          </ul>
      ...
      <p className="text-sm text-center text-neutral-500">&copy;2024 Heorhii Shvab. All rights reserved.</p>
    </footer>
  )
}
